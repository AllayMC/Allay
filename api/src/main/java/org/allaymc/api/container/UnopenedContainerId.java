...
/**
 * UnopenedContainerId contains ids that can be used to send
 * container content to the player without opening the container.
 * <p>
 ...
 *
 * @author daoge_cmd
 * @see org.allaymc.api.container.impl.PlayerContainer
 */
