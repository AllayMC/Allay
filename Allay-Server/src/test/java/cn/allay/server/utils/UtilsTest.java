...
public class UtilsTest {
    ...
    void testComputeRequiredBits() {
        ...
        assertEquals(1, Utils.computeRequiredBits(2));
        assertEquals(2, Utils.computeRequiredBits(3));
        assertEquals(2, Utils.computeRequiredBits(4));
        assertEquals(3, Utils.computeRequiredBits(5));
        assertEquals(3, Utils.computeRequiredBits(8));
        assertEquals(4, Utils.computeRequiredBits(9));
        assertEquals(4, Utils.computeRequiredBits(16));
        assertEquals(5, Utils.computeRequiredBits(17));
        assertEquals(5, Utils.computeRequiredBits(32));
