...
//                var splittedScoreScope = AllayStringUtils.fastSplit(SCORE_SCOPE_SEPARATOR, condition);
...
//            IScorer scorer = entity instanceof EntityPlayer player ? new PlayerScorer(player) : new EntityScorer(entity);
