...
public class BlockFurnaceBaseComponentImpl extends BlockBaseComponentImpl {
    public BlockFurnaceBaseComponentImpl(BlockType<? extends BlockBehavior> blockType) {
        super(blockType);
    }
