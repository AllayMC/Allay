...
public final class ItemTypeDefaultInitializer {
    ...
    public static void initCoralFanHang() {
        if (ItemTypes.CORAL_FAN_HANG != null) return;
        ItemTypes.CORAL_FAN_HANG = ItemTypeBuilder
    ...
    public static void initCoralFanHang2() {
        if (ItemTypes.CORAL_FAN_HANG2 != null) return;
        ItemTypes.CORAL_FAN_HANG2 = ItemTypeBuilder
    ...
    public static void initCoralFanHang3() {
        if (ItemTypes.CORAL_FAN_HANG3 != null) return;
        ItemTypes.CORAL_FAN_HANG3 = ItemTypeBuilder
    ...
    public static void initYellowFlower() {
        if (ItemTypes.YELLOW_FLOWER != null) return;
        ItemTypes.YELLOW_FLOWER = ItemTypeBuilder
