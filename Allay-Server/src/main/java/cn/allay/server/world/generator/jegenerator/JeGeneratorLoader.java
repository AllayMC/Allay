package cn.allay.server.world.generator.jegenerator;
...
public final class JeGeneratorLoader {
    ...
    public static void setup() {
        ...
        try {
            final Class<?> JeGeneratorMain = Class.forName("cn.allay.jegenerator.JeGeneratorMain", true, Allay.EXTRA_RESOURCE_CLASS_LOADER);
