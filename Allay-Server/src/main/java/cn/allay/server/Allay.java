...
import cn.allay.server.block.palette.AllayBlockPaletteRegistry;
...
public final class Allay {
    ...
    public static void initAllayAPI() throws MissingImplementationException {
        ...
        api.bind(BlockPaletteRegistry.class, () -> new AllayBlockPaletteRegistry(new AllayBlockPaletteRegistry.Loader()));
