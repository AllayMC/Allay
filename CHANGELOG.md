...
- Added `AllayBlockType.Builder.customizeAutoGeneratedItemType(Consumer<AllayItemType.Builder>)` to customize automatically generated block item types for custom blocks.
