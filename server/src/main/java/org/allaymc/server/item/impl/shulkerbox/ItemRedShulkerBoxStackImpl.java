...
public class ItemRedShulkerBoxStackImpl extends ItemStackImpl implements ItemRedShulkerBoxStack {
    @Delegate
    protected ItemItemStorableComponent itemStorableComponent;

    public ItemRedShulkerBoxStackImpl(ItemStackInitInfo initInfo,
