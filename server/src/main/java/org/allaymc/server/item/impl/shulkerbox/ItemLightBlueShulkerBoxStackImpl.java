...
public class ItemLightBlueShulkerBoxStackImpl extends ItemStackImpl implements ItemLightBlueShulkerBoxStack {
    @Delegate
    protected ItemItemStorableComponent itemStorableComponent;

    public ItemLightBlueShulkerBoxStackImpl(ItemStackInitInfo initInfo,
