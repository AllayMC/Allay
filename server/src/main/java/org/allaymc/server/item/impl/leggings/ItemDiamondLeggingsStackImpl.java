...
public class ItemDiamondLeggingsStackImpl extends ItemStackImpl implements ItemDiamondLeggingsStack {
    @Delegate
    protected ItemArmorBaseComponent armorBaseComponent;

    public ItemDiamondLeggingsStackImpl(ItemStackInitInfo initInfo,
