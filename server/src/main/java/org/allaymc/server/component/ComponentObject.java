...
public abstract class ComponentObject {
    ...
    public ComponentObject(ComponentInitInfo initInfo, List<ComponentProvider<? extends Component>> componentProviders) {
    ...
    private static class Initializer {
        public static void init(Object instance, ComponentInitInfo initInfo, List<ComponentProvider<? extends Component>> componentProviders) {
        ...
        protected static void injectComponentObject(Object instance, List<? extends Component> componentList) {
        ...
        protected static void injectComponentInstances(Object instance, List<? extends Component> componentList) {
