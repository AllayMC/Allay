 ...
 * Generates large 2x2 pine trees with leaves only at the top.
 *
 * @author daoge_cmd
 */
public class MegaPineTreeFeature extends TreeWorldFeature {
    ...
    // Leaf parameters matching NKMOT's ObjectBigSpruceTree(0.25f, 4)
    // Pine has leaves starting higher (smaller topSize) than spruce
    protected static final float LEAF_START_HEIGHT_MULTIPLIER = 0.25f;
    protected static final int BASE_LEAF_RADIUS = 4;
    ...
    public boolean place(WorldFeatureContext context, int x, int y, int z) {
        ...
        // Pine has smaller topSize (leaves only at top portion)
    ...
    /**
     * Place mega pine leaves in a stepped conical pattern.
