...
public class AllayBlockUpdateManager implements BlockUpdateManager {
    ...
    protected void tickNeighborUpdates() {
        ...
        while (count < initialNeighborUpdateCount && count < MAX_NEIGHBOR_UPDATE_PER_TICK && (update = neighborUpdates.poll()) != null) {
            ...
            var context0 = new BlockNeighborUpdateContext(block0, neighborBlock0, blockFace, oldNeighborState);
            ...
            if (layer1.getBehavior() instanceof BlockLiquidBehavior) {
                ...
                var context1 = new BlockNeighborUpdateContext(block1, neighborBlock0, blockFace, oldNeighborState);
    ...
    protected boolean callNeighborUpdateEvent(BlockNeighborUpdateContext context) {
