...
public abstract class BlockCropsBaseComponentImpl extends BlockBaseComponentImpl {
    ...
    public boolean canKeepExisting(BlockStateWithPos current, BlockStateWithPos neighbor, BlockFace face) {
        ...
        return neighbor.blockState().getBlockType() == BlockTypes.FARMLAND;
    }
    ...
    protected boolean onBoneMealUsed(Dimension dimension, Vector3ic pos, BlockState crop) {
        ...
        var newCrop = crop.setProperty(BlockPropertyTypes.GROWTH, Math.min(growth + ThreadLocalRandom.current().nextInt(4) + 2, 7));
