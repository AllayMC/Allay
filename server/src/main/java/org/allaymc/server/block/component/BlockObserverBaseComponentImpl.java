...
public class BlockObserverBaseComponentImpl extends BlockBaseComponentImpl {
    ...
    protected static final Duration PULSE_DURATION = Duration.ofMillis(100); // 2 ticks
    ...
    /**
     * Triggers a redstone pulse from the observer.
     */
    protected void triggerPulse(Block block) {
        ...
        // Update neighbors (output is from the back)
