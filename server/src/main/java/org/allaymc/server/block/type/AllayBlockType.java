...
public final class AllayBlockType<T extends BlockBehavior> implements BlockType<T> {
    ...
    public static class Builder {
        ...
        protected Consumer<AllayItemType.Builder> autoGeneratedItemTypeBuilderCustomizer = $ -> {
        };
        ...
        /**
         * Customizes automatically generated block item types before they are built and registered.
         * <p>
         * This customizer is only applied when Allay auto-creates the corresponding block item type.
         * It does not affect item types that were already registered manually.
         * <p>
         * The generated item identifier is still determined by the block identifier, so this hook is
         * intended for additional customization such as tags, components, item data, or definitions.
         *
         * @param autoGeneratedItemTypeBuilderCustomizer the customizer for auto-generated item builders
         * @return this builder
         */
        public Builder customizeAutoGeneratedItemType(Consumer<AllayItemType.Builder> autoGeneratedItemTypeBuilderCustomizer) {
            this.autoGeneratedItemTypeBuilderCustomizer = Objects.requireNonNull(autoGeneratedItemTypeBuilderCustomizer, "autoGeneratedItemTypeBuilderCustomizer");
            return this;
        }
        ...
        private void prepareItemType() {
            ...
            if (this.itemType == null) {
                ...
                var itemTypeBuilder = AllayItemType.builder(ItemStackImpl.class);
                autoGeneratedItemTypeBuilderCustomizer.accept(itemTypeBuilder);
                this.itemType = itemTypeBuilder
                        .identifier(itemId)
                        .build();
