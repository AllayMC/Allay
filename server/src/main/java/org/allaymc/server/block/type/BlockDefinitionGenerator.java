 ...
 * and its default {@link BlockStateData}.
 * <p>
...
public interface BlockDefinitionGenerator {
     ...
     * @param blockStateData the {@link BlockStateData} from the block type's default state
     * @return the generated {@link BlockDefinition} representing the given {@code blockType}
     */
    BlockDefinition generate(BlockType<?> blockType, BlockStateData blockStateData);
}
