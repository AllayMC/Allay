...
class AllayBlockTypeTest {
    ...
    void testCustomizeAutoGeneratedItemType() {
        var customTag = new ItemTag("minecraft:test_auto_generated_block_item");
        var blockType = AllayBlockType
                .builder(TestBlockImpl.class)
                .identifier("minecraft:test_block_with_customized_item")
                .setComponents(List.of(new TestComponentImpl()))
                .customizeAutoGeneratedItemType(itemBuilder -> itemBuilder.setItemTags(Set.of(customTag)))
                .build();
