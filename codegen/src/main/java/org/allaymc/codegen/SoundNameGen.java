...
public class SoundNameGen {
    ...
    public static void main(String[] args) {
        ...
        TypeSpec.Builder codeBuilder = TypeSpec.interfaceBuilder(ClassNames.SOUNDS)
        ...
        var javaFile = JavaFile.builder(ClassNames.SOUNDS.packageName(), codeBuilder.build())
                .indent(CodeGenConstants.INDENT)
                .skipJavaLangImports(true)
                .build();
        Files.writeString(Path.of("api/src/main/java/org/allaymc/api/world/Sounds.java"), javaFile.toString());
    }
