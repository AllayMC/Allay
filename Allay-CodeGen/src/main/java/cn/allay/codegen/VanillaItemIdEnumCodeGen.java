...
public class VanillaItemIdEnumCodeGen {
    ...
    private static final Path FILE_OUTPUT_PATH = Path.of("Allay-API/src/main/java/cn/allay/item/data/VanillaItemId.java");
    ...
    public static void generate() {
        ...
        var javaFile = JavaFile.builder("cn.allay.item.data", codeBuilder.build()).build();
