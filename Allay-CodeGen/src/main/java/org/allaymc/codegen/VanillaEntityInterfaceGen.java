...
public class VanillaEntityInterfaceGen {
    ...
    public static void generate() {
        ...
        for (var id : VanillaEntityId.values()) {
            ...
            if (!Files.exists(path)) {
                ...
                generateEntityClass(entityClassFullName, path);
                generateEntityTypeField(id, entityClassFullName);
            }
        }
    ...
    private static void generateEntityClass(ClassName entityClassName, Path path) throws IOException {
    ...
    @SneakyThrows
    private static void generateEntityTypeField(VanillaEntityId vanillaEntityId, ClassName entityClassName) {
        var className = ClassName.get("org.allaymc.server.entity.initializer", entityClassName.simpleName() + "Initializer");
        var initializer = CodeBlock.builder();
        initializer
                .add("$T.$N = $T\n", ENTITY_TYPES_CLASS_NAME, vanillaEntityId.name() + "_TYPE", ENTITY_TYPE_BUILDER_CLASS_NAME)
                .add("        .builder($T.class)\n", entityClassName)
