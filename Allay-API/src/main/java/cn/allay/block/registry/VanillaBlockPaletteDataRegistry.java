 ...
 */
@Slf4j
public class VanillaBlockPaletteDataRegistry extends SimpleMappedRegistry<VanillaBlockId, VanillaBlockPaletteDataRegistry.VanillaBlockPaletteDataEntry, Map<VanillaBlockId, VanillaBlockPaletteDataRegistry.VanillaBlockPaletteDataEntry>> {

    private static VanillaBlockPaletteDataRegistry INSTANCE;

    private VanillaBlockPaletteDataRegistry(RegistryLoader<VanillaBlockId[], Map<VanillaBlockId, VanillaBlockPaletteDataEntry>> loader) {
        super(VanillaBlockId.values(), loader);
    }

    public static VanillaBlockPaletteDataRegistry getInstance() {
        return INSTANCE;
    }

    public static void init(RegistryLoader<VanillaBlockId[], Map<VanillaBlockId, VanillaBlockPaletteDataEntry>> loader) {
        INSTANCE = new VanillaBlockPaletteDataRegistry(loader);
    }
    ...
    public static class Loader implements RegistryLoader<VanillaBlockId[], Map<VanillaBlockId, VanillaBlockPaletteDataEntry>> {
        ...
        protected NBTInputStream getNBTInputStream() {
            var input = VanillaBlockPaletteDataRegistry.class.getClassLoader().getResourceAsStream("block_palette.nbt");
            if (input == null)
