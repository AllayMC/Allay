 ...
 * Allay Project <br>
 */
public interface BlockExposedCopperDoorBehavior extends BlockBehavior {
  BlockType<BlockExposedCopperDoorBehavior> EXPOSED_COPPER_DOOR_TYPE = BlockTypeBuilder
