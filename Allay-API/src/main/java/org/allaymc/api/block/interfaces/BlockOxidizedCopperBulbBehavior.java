 ...
 * Allay Project <br>
 */
public interface BlockOxidizedCopperBulbBehavior extends BlockBehavior {
  BlockType<BlockOxidizedCopperBulbBehavior> OXIDIZED_COPPER_BULB_TYPE = BlockTypeBuilder
