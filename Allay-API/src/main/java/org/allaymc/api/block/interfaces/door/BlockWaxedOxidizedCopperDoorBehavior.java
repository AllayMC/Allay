 ...
 * Allay Project <br>
 */
public interface BlockWaxedOxidizedCopperDoorBehavior extends BlockBehavior {
  BlockType<BlockWaxedOxidizedCopperDoorBehavior> WAXED_OXIDIZED_COPPER_DOOR_TYPE = BlockTypeBuilder
