 ...
 * Allay Project <br>
 */
public interface BlockOxidizedCopperTrapdoorBehavior extends BlockBehavior {
  BlockType<BlockOxidizedCopperTrapdoorBehavior> OXIDIZED_COPPER_TRAPDOOR_TYPE = BlockTypeBuilder
