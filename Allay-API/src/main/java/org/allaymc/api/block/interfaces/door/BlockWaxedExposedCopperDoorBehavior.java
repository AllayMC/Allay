 ...
 * Allay Project <br>
 */
public interface BlockWaxedExposedCopperDoorBehavior extends BlockBehavior {
  BlockType<BlockWaxedExposedCopperDoorBehavior> WAXED_EXPOSED_COPPER_DOOR_TYPE = BlockTypeBuilder
