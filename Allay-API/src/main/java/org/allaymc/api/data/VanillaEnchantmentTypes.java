...
public class VanillaEnchantmentTypes {
    ...
    public static final EnchantmentProtectionType PROTECTION = new EnchantmentProtectionType();
    ...
    public static final EnchantmentWindBurstType WIND_BURST = new EnchantmentWindBurstType();
}
