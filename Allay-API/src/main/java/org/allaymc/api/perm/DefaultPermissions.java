...
public final class DefaultPermissions {
    ...
    public static final PermTree MEMBER =
            PermTree.create("Member")
                    ...
                    .addPerm(Command.COMMAND_PERM_PREFIX + "help")
    ...
    public static final PermTree OPERATOR =
            PermTree.create("Operator")
                    ...
                    .addPerm(Command.COMMAND_PERM_PREFIX + "gm")
                    .addPerm(Command.COMMAND_PERM_PREFIX + "gamerule")
                    .addPerm(Command.COMMAND_PERM_PREFIX + "gr")
                    .addPerm(Command.COMMAND_PERM_PREFIX + "gametest")
                    .addPerm(Command.COMMAND_PERM_PREFIX + "gt")
