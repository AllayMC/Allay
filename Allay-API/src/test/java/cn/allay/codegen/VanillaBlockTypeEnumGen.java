 ...
 * Allay Project <br>
 */
public class VanillaBlockTypeEnumGen {

    private static final Path BLOCK_PALETTE_FILE_PATH = Path.of("Allay-Server/src/main/resources/block_palette.nbt");
    private static final Path FILE_OUTPUT_PATH = Path.of("Allay-API/src/main/java/cn/allay/block/data/VanillaBlockTypes.java");
    ...
    public static void main(String[] args) {
        ...
        TypeSpec.Builder codeBuilder = TypeSpec.enumBuilder("VanillaBlockTypes")
                .addJavadoc(
                        "Author: daoge_cmd <br>\n" +
                        "Automatically generated by {@link cn.allay.codegen.VanillaBlockTypeEnumGen} <br>\n" +
                        "Allay Project <br>\n")
